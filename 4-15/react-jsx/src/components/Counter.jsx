                    ...
                    <div className={customClsx("col-sm-6")}>
                        <div className={customClsx("card")}>
                            <div
                                ...
                                <h3
                                    className={customClsx("mb-4")}>Counter</h3>
                                <p
                                    className={customClsx("display-4")}>{this.getValue()}</p>
                                <div
                                    className={customClsx("btn-group")}>
                                    <button
                                        className={customClsx("btn", "btn-primary")} onClick={this.handleIncrement}>
                                        Increment
                                    </button>
                                    <button
                                        className={customClsx("btn", "btn-danger")} onClick={this.handleDecrement}>
                                        Decrement
                                    </button>
                                </div>
                            </div>
